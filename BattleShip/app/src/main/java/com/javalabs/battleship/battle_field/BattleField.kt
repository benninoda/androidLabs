package com.javalabs.battleship.battle_field

import com.javalabs.battleship.models.ships.TwoDeckShip
        ...
        for (ship in ships) {
            ...
            while (!isAdded) {
                ...
                if (battleField[coordinate.x][coordinate.y]?.getCellState() == CellState.EMPTY) {
                    ...
                    isAdded = if (ship.getShipOrientation() == Direction.VERTICAL) {
...
//    }
    ...
    private fun getRandomCoordinate(ship: Ship): Coordinate {
        ...
        if (ship.getShipOrientation() == Direction.HORIZONTAL) {
